          ...
          <div className="relative border-t border-white/20 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/20">
              ...
              <div className="px-[20px] py-[16px]">
                ...
                <ul className="space-y-1 text-[16px] md:text-[18px]" aria-label="Site links">
              ...
              <div className="px-[20px] py-[16px]">
                ...
                <ul className="space-y-1 text-[16px] md:text-[18px]" aria-label="Social links">
              ...
              <div className="px-[20px] py-[16px]">
                ...
                <p className="text-[16px] md:text-[18px] leading-[1.25] text-white/85">
